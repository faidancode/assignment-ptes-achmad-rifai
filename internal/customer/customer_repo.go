...
type Repository interface {
	...
	GetCustomers(ctx context.Context) ([]dbgen.GetCustomersRow, error)
...
func (r *repository) GetCustomers(ctx context.Context) ([]dbgen.GetCustomersRow, error) {
	return r.q.GetCustomers(ctx)
}
